...
func TestCompilerScopes(t *testing.T) {
	...
	if last := compiler.scopes[compiler.scopeIndex].lastInstruction; last.OpCode != code.OpSub {
	...
	if last := compiler.scopes[compiler.scopeIndex].lastInstruction; last.OpCode != code.OpAdd {
		t.Errorf("lastInstruction.Opcode wrong. got=%d, want=%d",
			last.OpCode, code.OpAdd)
	}

	if prev := compiler.scopes[compiler.scopeIndex].previousInstruction; prev.OpCode != code.OpMul {
		t.Errorf("lastInstruction.Opcode wrong. got=%d, want=%d",
...
func testStringObject(expected string, actual object.Object) error {
	...
	if result.Value != expected {
		return fmt.Errorf("object has the wrong value. got=%q, want=%q",
